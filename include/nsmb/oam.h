...
namespace OAM
{
	 ...
	 * */
	void updateCounter(GXOamAttr* oamAttrs, GXOamAttr** oamCounterAttrTable, s32 value, s32 digitCount, u32 flags);
	 ...
	 * */
	bool draw(GXOamAttr* oamAttrs, s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, u32 settings);
	 ...
	 * \return True if the objects were pushed to the render list successfully, false otherwise.
	 * */
	bool draw(GXOamAttr* oamAttrs, s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, Vec2* scale, fx16 rot, s16 rotCenter[2], u32 settings);
	 ...
	 * \return True if the objects were pushed to the render list successfully, false otherwise.
	 * */
	bool drawMtx(GXOamAttr* oamAttrs, s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, MtxFx22* mtx, s32 unk8, u32 settings);
	 ...
	 * \return True if the objects were pushed to the render list successfully, false otherwise.
	 * */
	bool drawMtx(GXOamAttr* oamAttrs, s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, MtxFx22* mtx, s32 unk8, fx16 rot, s16 rotCenter[2], u32 settings);
	 ...
	 * \return True if the objects were pushed to the render list successfully, false otherwise.
	 * */
	bool drawSprite(GXOamAttr* oamAttrs, fx32 x, fx32 y, u32 flags, u8 palette, u8 affineSet, Vec2* scale, fx16 rot, s16 rotCenter[2], u32 settings);
	 ...
	 * \return True if the objects were pushed to the render list successfully, false otherwise.
	 * */
	bool drawSub(GXOamAttr* oamAttrs, s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, u32 settings);
	 ...
	 * \return True if the objects were pushed to the render list successfully, false otherwise.
	 * */
	bool drawSub(GXOamAttr* oamAttrs, s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, Vec2* scale, fx16 rot, s16 rotCenter[2], u32 settings);
	 ...
	 * \return True if the objects were pushed to the render list successfully, false otherwise.
	 * */
	bool drawMtxSub(GXOamAttr* oamAttrs, s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, MtxFx22* mtx, u32 settings);
	 ...
	 * \return True if the objects were pushed to the render list successfully, false otherwise.
	 * */
	bool drawMtxSub(GXOamAttr* oamAttrs, s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, MtxFx22* mtx, fx16 rot, s16 rotCenter[2], u32 settings);
	...
	public:
		 ...
		 * \param updateSpeed The frame update speed.
		 * */
		void setUpdateSpeed(fx32 updateSpeed) __attribute__((noinline))
		{
			if ( updateSpeed < 0 )
			{
				this->flags |= 4;
		 ...
		 * \return True if the objects were pushed to the render list successfully, false otherwise.
		 * */
		bool draw(s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, Vec2* scale, fx16 rot, s16 rotCenter[2], u32 settings) __attribute__((noinline)) {
		 ...
		 * \return True if the objects were pushed to the render list successfully, false otherwise.
		 * */
		bool drawSprite(fx32 x, fx32 y, u32 flags, u8 palette, u8 affineSet, Vec2* scale, fx16 rot, s16 rotCenter[2], u32 settings);
		 ...
		 * \return True if the objects were pushed to the render list successfully, false otherwise.
		 * */
		bool drawSub(s32 x, s32 y, u32 flags, u8 palette, u8 affineSet, Vec2* scale, fx16 rot, s16 rotCenter[2], u32 settings);
