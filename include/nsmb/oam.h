 ...
 * @n Examples of things that use %OAM: HUD, Goombas, Koopas, and so on...
 */
namespace OAM
{
	...
	public:
		 ...
		 * @return True if the objects were pushed to the render list successfully, false otherwise.
		 */
		bool draw(s32 x, s32 y, Flags flags, u8 palette, u8 affineSet, Vec2* scale, fx16 rot, s16(*rotCenter)[2], Settings settings) __attribute__((noinline)) {
