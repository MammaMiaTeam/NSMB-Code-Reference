...
public:
	...
	operator VecFx32& () { return *reinterp__ret_cast<VecFx32*>(&x); }
	operator const VecFx32& () const { return *reinterp__ret_cast<const VecFx32*>(&x); }

	inline VecFx32* vecfx() {
		return reinterp__ret_cast<VecFx32*>(&this->x);
	}
...
public:
	...
	operator VecFx16& () { return *reinterp__ret_cast<VecFx16*>(&x); }
	operator const VecFx16& () const { return *reinterp__ret_cast<const VecFx16*>(&x); }

	inline VecFx16* vecfx() {
		return reinterp__ret_cast<VecFx16*>(&this->x);
	}
