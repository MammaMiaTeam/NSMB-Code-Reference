...
#define ToAngle(x)		(((x) * 0x10000) / 360)
	...
	static fx32 smoothstep(fx32 start, fx32 end, fx32 step)
	{
		step = clamp01(step);
	...
	namespace Random {
		...
		// 0200e6f4
		GEN_SFUNC( u32 stage ) // used in stage related operations (actors, spawns, tile randomization)
