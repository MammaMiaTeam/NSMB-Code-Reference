...
consteval Fx16 operator""fxs(long double value) { return Fx16(__opfx_round<fx16>(value * 0x1000)); }
consteval Fx32 operator""fx(long double value) { return Fx32(__opfx_round<fx32>(value * 0x1000)); }
consteval Fx64 operator""fxl(long double value) { return Fx64(__opfx_round<fx64>(value * 0x1000)); }
consteval Fx64c operator""fxlc(long double value) { return Fx64c(__opfx_round<fx64>(value * 0x100000000)); }
